...
La source d'éclairage qui coûte le plus cher aux ménages est la `r cout_type_table[[1,1]]` avec une dépense moyenne mensuelle de **`r cout_type_table[[1,2]] %>% format(big.mark   = " ")`** Ariary par mois.
